...
public class PolarChart implements Serializable {

	private static final long serialVersionUID = 4858067197471282263L;
    ...
    public void plot(double[] theta, double[] r, String spec, float lineWidth, String title) {
    ...
    public void plot(double[] theta, double[] r, String spec, float lineWidth) {
    ...
    public void plot(double[] theta, double[] r, float lineWidth) {
    	String title = "fig" + counter ;
    	counter++ ;
        String spec = "-b" ;
        final XYSeries series = new XYSeries(title);
    ...
    public void plot(double[] theta, double[] r, String spec) {
    	String title = "fig" + counter ;
    	counter++ ;
        float lineWidth = 1 ;
        final XYSeries series = new XYSeries(title);
    ...
    public void plot(double[] theta, double[] r, int colorId) {
    	String title = "fig" + counter ;
    	counter++ ;
        final XYSeries series = new XYSeries(title);
        for (int i = 0; i < theta.length; i++)
    ...
    public void plot(double[] theta, double[] r) {
    	String title = "fig" + counter ;
    	counter++ ;
        String spec = "-b" ;
        float lineWidth = 1 ;
