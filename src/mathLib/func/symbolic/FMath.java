...
import mathLib.func.symbolic.operator.FAbs;
import mathLib.func.symbolic.operator.FAcos;
import mathLib.func.symbolic.operator.FAsin;
import mathLib.func.symbolic.operator.FCos;
import mathLib.func.symbolic.operator.FCosh;
import mathLib.func.symbolic.operator.FCoth;
import mathLib.func.symbolic.operator.FExp;
import mathLib.func.symbolic.operator.FLog;
import mathLib.func.symbolic.operator.FLog10;
import mathLib.func.symbolic.operator.FMax;
import mathLib.func.symbolic.operator.FMin;
import mathLib.func.symbolic.operator.FPow;
import mathLib.func.symbolic.operator.FSignum;
import mathLib.func.symbolic.operator.FSin;
import mathLib.func.symbolic.operator.FSinh;
...
//		return rlt;
	 ...
	 * @return
	 */
	public static VecMathFunc grad(MathFunc fun) {
	 ...
	 * @return
	 */
	public static VecMathFunc grad(MathFunc fun, String ...varNames) {
	 ...
	 * @return
	 */
	public static VecMathFunc grad(MathFunc fun,ObjList<String> varNames) {
	 ...
	 * @return
	 */
	public static MathFunc div(VecMathFunc vFun) {
		int dim = vFun.getDim();
		MathFunc rlt = C0;
		for(int i=1; i<=dim; i++) {
	 ...
	 * @return
	 */
	public static MathFunc div(VecMathFunc vFun, String ...varNames) {
	 ...
	 * @return
	 */
	public static MathFunc div(VecMathFunc vFun,ObjList<String> varNames) {
		MathFunc rlt = new FC(0.0);
		for(int i=1;i<=varNames.size();i++) {
			MathFunc fd = (MathFunc)vFun.get(i);
