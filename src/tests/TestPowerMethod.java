...
public class TestPowerMethod {
	...
	public static void main(String[] args) {
		...
		EigenValueVector v = iteration.solve(mat, 1e-15) ;
		EigenValueVector v1 = regular.solve(mat, 1e-15) ;
		...
		EigenValueVector v2 = shift.solve(mat, 1e-15) ;
		shift.printCommandLine(v2);
		
		System.out.println("\n");
		
		shift.setEstimatevalue(5);
		EigenValueVector v3 = shift.solve(mat, 1e-15) ;
		shift.printCommandLine(v3);
		
		System.out.println("\n");
		
		shift.setEstimatevalue(-20);
		EigenValueVector v4 = shift.solve(mat, 1e-15) ;
